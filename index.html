			...
			<div class="cardBox">
				...
				<div class="details">
					<div class="paySection">
						...
						<div class="otherNo">
							<input class="radio" type="radio" id="givenNumber" name="regNum" value="$user_data['user_id']" checked>
							<span>
						...
						<div class="otherNo">
							<label><br>
								...
								<input class="amountTxbx" type="text" name="amount" placeholder="Enter Your Amount Here {kshs}">
							</label>
							<br><br>
